...
object ApiEndPoint {
    ...
    object Foods {
        ...
        object SearchRecent : IApiEndPoint { override val path = "$API/$FOODS/search/recent"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
        object SearchSuggestions : IApiEndPoint { override val path = "$API/$FOODS/search/suggestions"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
        object FavoritesPaged : IApiEndPoint { override val path = "$API/$FOODS/favorites"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
        object BulkActive : IApiEndPoint { override val path = "$API/$FOODS/bulk/active"; override val method = HttpMethod.Patch; override val type = EndpointType.Json }
        ...
        class ByCategory(category: String) : IApiEndPoint { override val path = "$API/$FOODS/category/$category"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
    ...
    object Cart {
        ...
        class Delete(cartId: String) : IApiEndPoint { override val path = "$API/$CART/$cartId"; override val method = HttpMethod.Delete; override val type = EndpointType.Json }
    ...
    object Order {
        ...
        object GetPage : IApiEndPoint { override val path = "$API/$ORDER/page"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
    ...
    object Cafe {
        object GetList : IApiEndPoint { override val path = "$API/$CAFE"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
    ...
    object Chat {
        ...
        object EnsureConversation : IApiEndPoint {
            override val path = "$API/$CHAT/conversation"
            override val method = HttpMethod.Post
            override val type = EndpointType.Json
        }
        object EnsureOrderConversation : IApiEndPoint {
            override val path = "$API/$CHAT/conversation/order"
            override val method = HttpMethod.Post
            override val type = EndpointType.Json
        }
        object EnsureSellerConversation : IApiEndPoint {
            override val path = "$API/$CHAT/conversation/seller"
            override val method = HttpMethod.Post
            override val type = EndpointType.Json
        }
    ...
    object Seller {
        ...
        object Discounts : IApiEndPoint { override val path = "$API/$SELLER/discounts"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
        object CreateDiscount : IApiEndPoint { override val path = "$API/$SELLER/discounts"; override val method = HttpMethod.Post; override val type = EndpointType.Json }
        class UpdateDiscount(discountId: String) : IApiEndPoint { override val path = "$API/$SELLER/discounts/$discountId"; override val method = HttpMethod.Put; override val type = EndpointType.Json }
        class DeleteDiscount(discountId: String) : IApiEndPoint { override val path = "$API/$SELLER/discounts/$discountId"; override val method = HttpMethod.Delete; override val type = EndpointType.Json }
        object Reviews : IApiEndPoint { override val path = "$API/$SELLER/reviews"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
        class ReplyReview(reviewId: String) : IApiEndPoint { override val path = "$API/$SELLER/reviews/$reviewId/reply"; override val method = HttpMethod.Put; override val type = EndpointType.Json }
        object Categories : IApiEndPoint { override val path = "$API/$SELLER/categories"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
        object CreateCategory : IApiEndPoint { override val path = "$API/$SELLER/categories"; override val method = HttpMethod.Post; override val type = EndpointType.Json }
        class UpdateCategory(categoryId: String) : IApiEndPoint { override val path = "$API/$SELLER/categories/$categoryId"; override val method = HttpMethod.Put; override val type = EndpointType.Json }
        class DeleteCategory(categoryId: String) : IApiEndPoint { override val path = "$API/$SELLER/categories/$categoryId"; override val method = HttpMethod.Delete; override val type = EndpointType.Json }
    }
    ...
    object Notifications {
        ...
        class MarkRead(id: String) : IApiEndPoint { override val path = "$API/$NOTIFICATIONS/$id/read"; override val method = HttpMethod.Put; override val type = EndpointType.Json }
        class Delete(id: String) : IApiEndPoint { override val path = "$API/$NOTIFICATIONS/$id"; override val method = HttpMethod.Delete; override val type = EndpointType.Json }
    }
    ...
    object Address {
        ...
        class Update(id: String) : IApiEndPoint { override val path = "$API/$ADDRESS/$id"; override val method = HttpMethod.Put; override val type = EndpointType.Json }
    }
    ...
    object Admin {
        object Capabilities : IApiEndPoint { override val path = "$API/$ADMIN/capabilities"; override val method = HttpMethod.Get; override val type = EndpointType.Json }
