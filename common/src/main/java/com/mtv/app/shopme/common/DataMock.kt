...
val mockOrders = listOf(
    OrderModel(
        ...
        cafeId = "cafe1",
        items = mapOf(
            "1" to OrderItemModel(foodId = 1, quantity = 2, price = 9.99),
            "7" to OrderItemModel(foodId = 7, quantity = 1, price = 3.29)
        ),
        totalPrice = 23.27,
        status = OrderStatus.ORDERED,
        timestamp = System.currentTimeMillis(),
        deliveryAddress = "Puri Lestari - Blok G06/01"
    ),
    OrderModel(
        id = "order002",
        customerId = "cust002",
        cafeId = "cafe1",
        items = mapOf(
            "2" to OrderItemModel(foodId = 2, quantity = 1, price = 12.49),
            "5" to OrderItemModel(foodId = 5, quantity = 2, price = 4.99)
        ),
        totalPrice = 22.47,
    ...
    OrderModel(
        ...
        cafeId = "cafe1",
        items = mapOf(
            "3" to OrderItemModel(foodId = 3, quantity = 1, price = 10.99)
        ),
        totalPrice = 10.99,
