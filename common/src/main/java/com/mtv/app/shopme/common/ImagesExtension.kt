...
fun uriToCompressedJpegFile(
    ...
    val decodedBitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.size, bitmapOptions) ?: return null

    val fixedBitmap = fixBitmapOrientation(bytes, decodedBitmap)
...
fun fixBitmapOrientation(bytes: ByteArray, bitmap: Bitmap): Bitmap {
    val matrix = Matrix()
