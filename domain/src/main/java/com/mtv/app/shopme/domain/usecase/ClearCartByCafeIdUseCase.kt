...
) : BaseUseCase<CartClearByCafeRequest, ApiResponse<Unit>>(dispatcher) {

    override suspend fun execute(param: CartClearByCafeRequest) = repository.request<ApiResponse<Unit>>(
